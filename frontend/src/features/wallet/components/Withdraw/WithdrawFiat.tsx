...
export default function WithdrawFiat() {
  ...
  return (
    <div className="space-y-4 text-white">
              ...
              <button
                ...
                className={cn(
                  ...
                  amount === String(p)
                    ...
                    : "bg-[#1E253C] text-white/80 hover:bg-gradient-to-r hover:from-[#007CC4] hover:to-[#31CFFF] hover:text-white active:translate-y-[1px]"
                )}
              >
                ${p}
              </button>
      ...
      <Field label="Your withdraw card number">
        <input
      ...
      {/* Warning */}
      <div className="rounded-lg bg-[#FFBB001A]/90 p-1 text-[13px] text-white/80">
        <div className="flex items-start gap-2">
          ...
          <span className={`${montserrat.className} text-[14px] text-[#EAF0F9]`}>
            Please ensure all fields are filled in correctly before making a withdraw
          </span>
        </div>
      </div>
