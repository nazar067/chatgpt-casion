...
export default function ActionRequiredModal() {
    ...
    <DialogRoot open={isOpen} onClose={close}>
      ...
      >
        ...
        <div className="mx-auto mt-6 mb-4 h-[150px] w-[150px] relative">
          <Image
            src="/deposit-popup/action-required.png"
            alt="Success"
            fill
        ...
        <div className="mt-6 gap-3">
          <button
            onClick={close}
            className={`${montserrat.className} h-20 w-full rounded-xl bg-[#1E253C] text-base font-[700] text-white/90 hover:bg-[#232941] cursor-pointer border border-white/10 active:translate-y-[1px]`}
          >
            Got it
          </button>
        </div>
